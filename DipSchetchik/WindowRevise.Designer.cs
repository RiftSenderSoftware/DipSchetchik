namespace DipSchetchik
{
    partial class WindowRevise
    {
        ...
        {
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.WindowRevice_Closed);
            ...
            this.button2.Text = "Открыть отчет 1";
            ...
            this.button3.Text = "Открыть отчет 2";
